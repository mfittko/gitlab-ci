module Charts
  ...
  class BuildTime < Chart
    def collect
      builds = project.builds.where('builds.finished_at is NOT NULL AND builds.started_at is NOT NULL AND builds.success is true').last(Settings.charts['builds_time_span'])
